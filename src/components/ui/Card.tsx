...
export const Card: React.FC<CardProps> = ({ className, children }) => (
  <div className={cn('rounded-xl border border-gray-800 bg-gray-950 text-gray-200 shadow-sm', className)}>
    {children}
  </div>
);

export const CardHeader: React.FC<{ className?: string; children: ReactNode }>= ({ className, children }) => (
  <div className={cn('p-4 border-b border-gray-800', className)}>{children}</div>
);
...
export const CardFooter: React.FC<{ className?: string; children: ReactNode }>= ({ className, children }) => (
  <div className={cn('p-4 border-t border-gray-800', className)}>{children}</div>
);

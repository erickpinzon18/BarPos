        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link to="/waiter/home" className="flex items-center">
              ...
              <span className="text-xl font-bold tracking-tighter text-white">Bar POS</span>
            </Link>
            <nav className="flex items-center gap-4 text-sm">
              <Link to="/waiter/home" className="hover:text-amber-400">Mesas</Link>
              <Link to="/waiter/checkout" className="hover:text-amber-400">Checkout</Link>
            </nav>
          </div>
        </div>
      </header>

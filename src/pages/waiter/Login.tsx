...
const WaiterLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Enforce waiter role
      if (user.role !== 'waiter') {
        setError('Acceso denegado. Solo meseros pueden acceder.');
        setLoading(false);
        return;
      }
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-amber-400 font-semibold">Mesero</p>
          <p className="text-sm text-gray-500 mt-2">Gestión de mesas y pedidos</p>
        </div>
